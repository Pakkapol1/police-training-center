<?php
$title = 'รายการไฟล์ทำเนียบกำลังสัญญาบัตร';
include __DIR__ . '/../header.php';
?>
<div class="container mt-4">
    <h2><?= $title ?></h2>
    <a href="/admin?action=officer-directory&sub_action=add" class="btn btn-success mb-3">+ อัปโหลดไฟล์ใหม่</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($file['pdf_file']): ?>
                                <a href="<?= $file['pdf_file'] ?>" target="_blank" class="btn btn-outline-danger btn-sm">
                                    <i class="fas fa-download"></i> ดาวน์โหลด
                                </a>
                            <?php else: ?>
                                <span class="text-muted">-</span>
                        ...
                        <td>
                            <a href="/admin?action=officer-directory&sub_action=delete&id=<?= htmlspecialchars($file['id']) ?>" 
