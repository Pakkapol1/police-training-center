<?php
$title = 'อัปโหลดทำเนียบกำลังสัญญาบัตร';
...
<div class="container mt-4">
    ...
    <?php endif; ?>
    <?php if (!empty($debug)): ?>
        <div class="alert alert-warning">DEBUG: <?= htmlspecialchars($debug) ?></div>
    <?php endif; ?>
    <form method="post" enctype="multipart/form-data">
        ...
        <a href="/admin?action=officer-directory" class="btn btn-secondary">ยกเลิก</a>
    </form>
</div>
