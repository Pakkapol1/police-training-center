    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-edit text-primary"></i> <?= htmlspecialchars($title) ?>
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="order_number" 
                                       name="order_number" 
                                       value="<?= isset($_POST['order_number']) ? htmlspecialchars($_POST['order_number']) : htmlspecialchars($item['order_number']) ?>" 
                                       min="1" 
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="rank" 
                                       name="rank" 
                                       value="<?= isset($_POST['rank']) ? htmlspecialchars($_POST['rank']) : htmlspecialchars($item['rank']) ?>" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="first_name" 
                                       name="first_name" 
                                       value="<?= isset($_POST['first_name']) ? htmlspecialchars($_POST['first_name']) : htmlspecialchars($item['first_name']) ?>" 
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="last_name" 
                                       name="last_name" 
                                       value="<?= isset($_POST['last_name']) ? htmlspecialchars($_POST['last_name']) : htmlspecialchars($item['last_name']) ?>" 
                                       required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="start_date" 
                                           name="start_date" 
                                           value="<?= isset($_POST['start_date']) ? htmlspecialchars($_POST['start_date']) : htmlspecialchars($item['start_date'] ?? '') ?>"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="end_date" 
                                           name="end_date" 
                                           value="<?= isset($_POST['end_date']) ? htmlspecialchars($_POST['end_date']) : htmlspecialchars($item['end_date'] ?? '') ?>"
                                           placeholder="วว/ดด/พศศศ">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               name="is_current" 
                                               value="1" 
                                               <?= (isset($_POST['is_current']) && $_POST['is_current']) || (isset($item['is_current']) && $item['is_current']) ? 'checked' : '' ?>>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">
                        <i class="fas fa-info-circle text-info"></i> ข้อมูลปัจจุบัน
                    </h6>
                </div>
                <div class="card-body">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="mb-0">
                        <i class="fas fa-exclamation-triangle text-warning"></i> คำแนะนำ
                    </h6>
                </div>
                <div class="card-body">
...
// สำหรับแสดงข้อมูลเดิม เมื่อโหลดหน้า
document.addEventListener('DOMContentLoaded', function() {
    // ถ้ามีค่า ISO date ในฟิลด์ ให้แปลงเป็นรูปแบบไทย
    const startDateInput = document.getElementById('start_date');
    const endDateInput = document.getElementById('end_date');
    
    setTimeout(() => {
        if (startDateInput.value && startDateInput.thaiDatePicker) {
            // ถ้าค่าเป็น ISO format (YYYY-MM-DD) ให้แปลงเป็นไทย
            if (startDateInput.value.match(/^\d{4}-\d{2}-\d{2}$/)) {
                startDateInput.thaiDatePicker.setDateFromISO(startDateInput.value);
            }
        }
        
        if (endDateInput.value && endDateInput.thaiDatePicker) {
            // ถ้าค่าเป็น ISO format (YYYY-MM-DD) ให้แปลงเป็นไทย
            if (endDateInput.value.match(/^\d{4}-\d{2}-\d{2}$/)) {
                endDateInput.thaiDatePicker.setDateFromISO(endDateInput.value);
            }
        }
    }, 100);
});
