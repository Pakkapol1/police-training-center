...
<div class="container my-5">
    <div class="row mb-4">
        <div class="col-12 text-center">
            ...
            <img src="/assets/img/stic.webp" alt="โลโก้หน่วยงาน" class="mb-3" style="height: 80px;">
                <h1 class="official-title mb-2">ทำเนียบกำลังสัญญาบัตร</h1>
    ...
    <?php if (!empty($file)): ?>
        ...
        <?php elseif (!empty($file['html_content'])): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <div class="alert alert-warning">ยังไม่มีการอัปโหลดไฟล์ทำเนียบกำลังสัญญาบัตร</div>
    <?php endif; ?>
</div>